...
module.exports = {
  ...
  run: async (client, message, args ) => {
      //--------------------------------------S T A R T---------------------------------------
        ...
        .setTitle('<:away:891614318393688085> Como usar: Uptimer!')
        .addField("<:reply:891618744814686269> **Get the link**",
      ...
      .setTitle('<:away:891614318393688085> Como usar: Uptimer!')
      .addField("<:reply:891618744814686269> **Run the command**",
      ...
      .setTitle('<:away:891614318393688085> Como usar: Uptimer!')
      .addField("ㅤ<:reply:891618744814686269> **Other Commands**","Agora que adicionamos seu projeto, você pode usar outro comando, como `projects` `remove` `stats` e `total`. Abaixo está uma imagem do comando remove")
